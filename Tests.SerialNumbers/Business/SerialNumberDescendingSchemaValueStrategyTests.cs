...
{
    [TestFixture]
    public class SerialNumberDescendingSchemaValueStrategyTests : TestsBase<SerialNumberDescendingSchemaValueStrategy>
    {
        [Test]
        ...
        [TestCase(0)]
        [TestCase(10)]
        public void IsSuitable_WhenSchemaDefinitionIncrementIsZeroOrPositive_ShouldReturnFalse(int increment)
        {
            var schemaValue = Create<SchemaValue>();
            var schemaDefinition = Create<SchemaDefinition>();
